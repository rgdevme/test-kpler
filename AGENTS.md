...
- **ESM only**: Use Node 24 for repository tooling, packages, and managed runtimes.
- **Node runtime pinning**: Pin Node 24 in every package engine and platform runtime configuration.
...
- [Senior Full-Stack Software Engineer Challenge](info/assignment.md)
